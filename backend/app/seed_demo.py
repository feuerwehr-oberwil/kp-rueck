...
async def seed_demo_shared_resources(db: AsyncSession) -> None:
    ...
    personnel_data = [
        ...
        {"name": "Ackermann Reto", "role": "Offizier", "status": "available", "tags": ["F"]},
        # Wachtmeister
        ...
        {"name": "Bühler Nadja", "role": "Wachtmeister", "status": "available", "tags": ["F"]},
        {"name": "Frei Marc", "role": "Wachtmeister", "status": "available", "tags": ["F", "Fw"]},
        {"name": "Suter Beat", "role": "Wachtmeister", "status": "available", "tags": ["F"]},
        {"name": "Widmer Anna", "role": "Wachtmeister", "status": "available", "tags": ["Hö"]},
        # Korporal
        ...
        {"name": "Gerber Elias", "role": "Korporal", "status": "available", "tags": ["F"]},
        {"name": "Lüthi Sophie", "role": "Korporal", "status": "available", "tags": []},
        {"name": "Kaufmann Nico", "role": "Korporal", "status": "available", "tags": ["Fw"]},
        {"name": "Moser Lea", "role": "Korporal", "status": "available", "tags": ["F"]},
        {"name": "Wenger Tim", "role": "Korporal", "status": "available", "tags": []},
        # Mannschaft
        ...
        {"name": "Berger Yves", "role": "Mannschaft", "status": "available", "tags": []},
        {"name": "Christen Mia", "role": "Mannschaft", "status": "available", "tags": []},
        {"name": "Vogel Timo", "role": "Mannschaft", "status": "available", "tags": []},
        {"name": "Egli Sarah", "role": "Mannschaft", "status": "available", "tags": []},
        {"name": "Bianchi Luca", "role": "Mannschaft", "status": "available", "tags": ["Fw"]},
        {"name": "Portmann Jonas", "role": "Mannschaft", "status": "available", "tags": []},
    ]
...
async def seed_demo_event_content(db: AsyncSession, event: models.Event) -> None:
    ...
    transitions = [
        ...
        transition("Wasser im Keller Gewerbebau", "incoming", "reko", 27, "Reko aufgeboten"),
        # Completed Rekos
        transition("Abgedecktes Dach Scheune", "incoming", "reko", 98, "Reko aufgeboten"),
        transition("Abgedecktes Dach Scheune", "reko", "reko_done", 76, "Reko abgeschlossen, Bericht liegt vor"),
        transition("Wasser im Keller Doppelhaus", "incoming", "reko", 93, "Reko aufgeboten"),
        transition("Wasser im Keller Doppelhaus", "reko", "reko_done", 70, "Reko abgeschlossen"),
        # Disponiert
        transition("Überflutete Strasse", "incoming", "enroute", 20, "Mowa disponiert"),
        transition("Wasser im Keller Reihen-EFH", "incoming", "enroute", 15, "Gruppe zu Fuss unterwegs"),
        # Einsatz — Tiefgarage Zentrum
        transition("Wasser in Tiefgarage Zentrum", "incoming", "enroute", 82, "Trawa mit Pumpenmodul disponiert"),
        transition("Wasser in Tiefgarage Zentrum", "enroute", "active", 68, "Vor Ort, Pumpen laufen"),
        # Ölwehr Dorfbach — reko trail, then worked and finished
        transition("Ölfilm auf Dorfbach", "incoming", "reko", 160, "Reko aufgeboten"),
        transition("Ölfilm auf Dorfbach", "reko", "reko_done", 143, "Reko abgeschlossen"),
        transition("Ölfilm auf Dorfbach", "enroute", "active", 120, "Mawa vor Ort, Ölsperre gesetzt"),
        transition("Ölfilm auf Dorfbach", "active", "returning", 45, "Rückbau läuft"),
        # Closed out
        transition("Wasser im Keller Praxis", "incoming", "reko", 170, "Reko aufgeboten"),
        transition("Wasser im Keller Praxis", "reko", "reko_done", 159, "Reko abgeschlossen"),
        transition("Wasser im Keller Praxis", "reko_done", "complete", 40, "Kein Einsatz nötig, abgeschlossen"),
        transition(
            "Wasser im Keller Einliegerwohnung", "active", "complete", 55, "Keller ausgepumpt, Einsatz abgeschlossen"
        ),
    ]
