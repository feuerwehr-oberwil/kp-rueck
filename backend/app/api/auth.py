...
async def change_password(
    ...
    New password must meet strength requirements (in production).

    SECURITY: Users can only change their own passwords.
    Editors who want to reset other users' passwords should use PUT /api/users/{user_id}.
    """
    from ..crud import change_user_password
