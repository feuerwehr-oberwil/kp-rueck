...
down_revision: Union[str, Sequence[str], None] = '62602ddaaa6f'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('event_id', 'personnel_id', 'function_type', 'vehicle_id', name='unique_personnel_function_assignment'),
    )
    ...
    op.create_index('idx_event_special_functions_function_type', 'event_special_functions', ['event_id', 'function_type'])
