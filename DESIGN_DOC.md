...
Version: 1.1
Date: 2025-10-23
Prepared for: Feuerwehr Oberwil

## 1\. Overview

The KP Rück – Digital Einsatz-Board replaces the existing physical magnet board system used in the Feuerwehr Oberwil command post (KP Rück).
