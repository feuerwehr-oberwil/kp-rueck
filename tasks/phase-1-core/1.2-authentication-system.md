...
- ⏳ **Backend authentication pending**
  - API endpoints still publicly accessible
  - Need to implement /api/auth endpoints
  - Need to protect existing routes with authentication
...
- [ ] Refresh tokens work to renew access
...
- [ ] SECRET_KEY changed from default (production)
- [ ] COOKIE_SECURE=true in production (HTTPS only)
- [ ] Password minimum length enforced (8 chars)
- [ ] Bcrypt rounds configured (12)
- [ ] No passwords in logs or error messages
- [ ] Rate limiting on login endpoint (implement in Task 6.4)
- [ ] JWT includes expiration claim
- [ ] Refresh tokens validated for type
- [ ] User lookup by UUID (not username in token)
