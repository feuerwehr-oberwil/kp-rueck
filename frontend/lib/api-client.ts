...
class ApiClient {
  ...
  /**
   * Main request method with retry logic and error notifications. The transport
   * itself is `lib/api/http.ts`; every method below goes through this delegate.
   */
