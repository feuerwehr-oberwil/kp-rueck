...
describe("areOperationsEqual", () => {
  ...
  // These five were rendered by the card but missing from its hand-written memo comparator,
  // so changing any of them left the card showing stale content with no self-heal.
  it.each([
