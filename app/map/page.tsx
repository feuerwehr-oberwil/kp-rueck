...
export default function MapPage() {
  ...
  const [selectedOpId, setSelectedOpId] = useState<string | null>(highlightParam)
  ...
  useEffect(() => {
    if (highlightParam) {
      setSelectedOpId(highlightParam)
    }
  }, [highlightParam])
    ...
    <div className="flex h-screen flex-col bg-background text-foreground">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 p-4">
          <MapView operations={activeOperations} onMarkerClick={setSelectedOpId} selectedOperationId={selectedOpId} />
        </main>
