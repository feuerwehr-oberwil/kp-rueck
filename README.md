...
This application was **vibecoded** (AI-assisted development) and extensively tested with real-world workflows from **Demo Fire Department** (Switzerland). While it's tailored to their specific operational needs, the codebase is flexible and can be adapted to other fire departments or emergency services.
